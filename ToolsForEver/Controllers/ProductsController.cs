...
namespace ToolsForEver.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var products = db.Products.Include(p => p.Factory);

            if (!string.IsNullOrEmpty(searchProduct))
            {
                products = products.Where(x => x.Name.Contains(searchProduct));
            }
        ...
        public ActionResult Create([Bind(Include = "Id,Name,FactoryId,Type,Buy,Sell")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,FactoryId,Type,Buy,Sell")] Product product)
        {
            if (ModelState.IsValid)
            {
